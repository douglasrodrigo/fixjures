...
public final class Strategies {
	...
	public static interface SourceStrategy {
		...
		/**
		 * Produces a byte channel from which fixture data can be read for an object
	...
	/**
	 * A strategy for producing resource names where fixture data is stored for objects
	 * of a given type and name.
	 */
	public static interface ResourceNameStrategy {

		/**
		 * Produces a name of a resource from which fixture data can be read for an object
		 * of the given type and name.
		 *
		 * @param type fixture object type
		 * @param name object name or id
	 ...
	 * <p>
	 * This strategy makes the factory look for fixtures in the classpath in
	 * "fixjures/<i>package.Class</i>/<i>name</i>.json".
	 */
	public static final ResourceNameStrategy DEFAULT_CLASSPATH_NAME_STRATEGY = newFormatStringStrategy("fixjures/%s/%s.json");

	/**
	 * Creates a new resource name strategy based on a format string that will be
	 * passed to {@code String.format} with {@code type.getName()} and {@code name} as the format
	 * arguments.
	 *
	...
	/**
	 * This source strategy does a simple lookup of type and name in a map that stores
	 * fixture data in raw byte arrays. A defensive copy is made of the map argument, so only
	 * the fixtures in the map at the time this method is invoked can be created.
	 *
	...
	/**
	 * Creates a new source strategy that looks for fixture source data in the classpath based on
	 * {@link #DEFAULT_CLASSPATH_NAME_STRATEGY}.
	 *
	 * @return new source strategy
	 */
	...
	/**
	 * Creates a new source strategy that looks for fixture source data in files based on
	 * {@link #DEFAULT_CLASSPATH_NAME_STRATEGY}.
	 *
	 * @return new source strategy
	 */
